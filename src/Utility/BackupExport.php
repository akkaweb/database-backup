...
class BackupExport
{
     ...
     * With the `filename()` method, the compression type will be
     * automatically set.
     * @var string
     * @see compression()
     * @see filename()
     ...
     * Use the `filename()` method to set the filename where to export the
     * database.
     * @var string
     * @see filename()
     */
    ...
    /**
     * Rotate. This is the number of backups you want to keep. So, it will
     * delete all backups that are older.
     * Use the `rotate()` method to set the filename where to export the
     * database.
     * @var int
     * @see rotate()
     */
    ...
    public function compression($compression)
    {
        ...
        //If the file extension exists, so the compression type is valid
    ...
    /**
     * Sets the database connection to use and returns the connection
     * parameters.
